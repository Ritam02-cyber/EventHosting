    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('participant_obj', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='event_app.participant')),
            ],
        ),
        migrations.CreateModel(
            name='Profile',
        ...
        migrations.AddField(
            ...
            name='prof',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='event_app.profile'),
        ),
        migrations.CreateModel(
            name='MCQField',
            fields=[
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(related_name='event_participant', to='event_app.Participant'),
        ),
        migrations.AddField(
            model_name='event',
            name='host',
